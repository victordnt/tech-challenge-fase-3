...
import {
  ...
  filterTransactions,
} from "@/features/TransactionsList/services/finance";
...
export default function DashboardScreen() {
  ...
  const summary = useMemo(
    () => calculateDashboardSummary(filteredTransactions),
    ...
    >
      ...
      >
        ...
        <ThemedView style={[styles.header, { backgroundColor: "transparent" }]}>
          <ThemedView
            style={[styles.headerLeft, { backgroundColor: "transparent" }]}
          >
          ...
          >
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <ThemedText style={styles.newTransactionButtonText}>
                + Nova Transação
              </ThemedText>
            </TouchableOpacity>
          </ThemedView>
        ...
        {transactionsLoading ? (
          ...
          >
            ...
            {hasMore ? (
              <TouchableOpacity
                onPress={loadMore}
                style={[styles.newTransactionButton, { marginTop: 12 }]}
              >
